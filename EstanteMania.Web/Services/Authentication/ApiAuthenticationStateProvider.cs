...
namespace EstanteManiaWebAssembly.Services.Authentication
{
    public class ApiAuthenticationStateProvider : AuthenticationStateProvider
    {
        ...
        private static bool TokenExpirou(string tokenDate)
        {
            ...
            if (DateTime.TryParseExact(tokenDate, "yyyy-MM-dd'T'HH:mm:ss.fffffff'Z'", null,
                System.Globalization.DateTimeStyles.RoundtripKind, out DateTime expirationDate))
            {
                return DateTime.UtcNow > expirationDate;
            }

            // Caso não seja possível fazer o parse da data, considere o token como expirado.
            return true;
        }
